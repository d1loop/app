...
import { Tweet } from '@components/post/post';
    ...
    <MainContainer>
      ...
      >
        <ActionModal
          ...
          description='This can’t be undone and you’ll remove all the posts you’ve added to your Bookmarks.'
